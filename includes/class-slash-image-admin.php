		...
		wp_localize_script(
			...
			array(
				...
				'i18n'     => array(
					...
					'warn_shortpixel'           => __( 'Keep ShortPixel installed until this finishes. Afterwards you can uninstall it normally - but do NOT use its "Remove all data" tool. That permanently deletes the WebP and AVIF files on your server, which SlashImage now serves to your visitors directly. They cannot be recovered.', 'slashimage-image-optimizer' ),
					...
					'stat_importable'           => __( 'Ready to migrate', 'slashimage-image-optimizer' ),
					...
					'stat_skipped_status'       => __( 'Skipped - cannot be migrated', 'slashimage-image-optimizer' ),
					...
					'stat_missing_disk'         => __( 'Files no longer on the server', 'slashimage-image-optimizer' ),
