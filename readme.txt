...
* Fix: Uninstalling with "remove all data" enabled now clears everything SlashImage stored. Previously a few settings and per-image records were left behind.
